...
3) npm i nodemon
4) npm i bcryptjs jsonwebtoken validator nodemailer
5) npm i cookie-parser body-parser
...
2) npm i axios react-alert react-alert-template-basic react-helmet react-redux redux redux-thunk redux-devtools-extension react-router-dom overlay-navbar
3) npm i webfontloader
4) npm install react-icons@3
5) npm i react-rating-stars-component
6) npm i react-material-ui-carousel
